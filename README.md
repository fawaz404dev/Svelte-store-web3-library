...
Discord](https://discord.gg/fawaz404dev).
...
Please check
 `examples/svelte-app-template-web3/src/Web3Modal.svelte`(https://github.com/fawaz404dev/Svelte-store-web3-library/tree/master/examples/svelte-app-template-web3/src/Web3Modal.svelte).
...
Please check [examples/svelte-app-template-web3 on github](https://github.com/fawaz404dev/Svelte-store-web3-library/tree/master/examples/svelte-app-template-web3).

Contains demos to use the default store and multi stores.

### SvelteKit basic example

Please check [examples/sveltekit-app-template-web3 on github](https://github.com/fawaz404dev/Svelte-store-web3-library/tree/master/examples/sveltekit-app-template-web3).

### Sapper basic example (based on webpack template)

Please check [examples/sapper-app-template-web3 on github](https://github.com/fawaz404dev/Svelte-store-web3-library/tree/master/examples/sapper-app-template-web3).
